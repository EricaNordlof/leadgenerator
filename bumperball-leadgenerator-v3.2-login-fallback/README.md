...
- Vanlig JavaScript-inloggning har kompletterats med server-side reservinloggning.
- Sessionsdata sparas uttryckligen innan svaret eller omdirigeringen skickas.
- Formuläret fungerar även om `app.js` blockeras eller inte laddas.
